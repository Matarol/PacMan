...
function animate() {
    ...
    boundaries.forEach((boundary) => {
        ...
        if (player.position.y <= boundary.position.y + boundary.height) {
            console.log("Det här borde inte skrivas ut för det finns ju ingen boundary med lägre y-position?")
        }
